...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_DARTRIX] = { {EVO_LEVEL_DAY, 36, SPECIES_DECIDUEYE_H, 0},
	...
	[SPECIES_TOXEL] =            {{EVO_NATURE_HIGH, 30, SPECIES_TOXTRICITY, 0},	//Personality values are the closest to nature I can think of. Cascoon has a high personality value, btw
	...
	[SPECIES_YAMASK_G] =         {{EVO_DAMAGE_LOCATION, MAPSEC_ROCK_TUNNEL, SPECIES_RUNERIGUS, 49}/*,
